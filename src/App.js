  ...
  return (
    <div className="container">
      ...
      <form onSubmit={handleSubmit} className="form">
        <input type="date" name="day" value={formData.day} onChange={handleChange} className="input" />
        ...
        {formData.times.map((time, index) => (
          <div key={index} className="time-slot">
            <input type="time" name="startTime" value={time.startTime} onChange={(e) => handleChange(e, index)} className="input" />
            <input type="time" name="endTime" value={time.endTime} onChange={(e) => handleChange(e, index)} className="input" />
        ...
        <input type="number" name="rate" placeholder="Hourly Rate" value={formData.rate} onChange={handleChange} className="input" />
